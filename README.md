...
## � Changelog
### v2.0.0 (2026-07-16)
- 🏗️ **Reestruturação completa**: Sistema agora na versão **v2.0.0** com interface simplificada e navegação exclusiva no modo **API** (Instâncias, Chamadas, PIX, API Docs)
